...
function isValidApplication(obj: unknown): obj is Application {
  ...
  return (
    ...
    ["applied", "interviewing", "offer", "rejected", "unresponsive", "ghosted"].includes(a.status as string) &&
...
export function addGuestApplication(formData: ApplicationFormData): Application {
  ...
  const newApp: Application = {
    ...
    status: ["applied", "interviewing", "offer", "rejected", "unresponsive", "ghosted"].includes(formData.status)
      ? formData.status 
      : "applied",
