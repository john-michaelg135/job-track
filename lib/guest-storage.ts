...
function isValidApplication(obj: unknown): obj is Application {
  ...
  return (
    ...
    ["applied", "interviewing", "offer", "rejected", "unresponsive"].includes(a.status as string) &&
...
export function addGuestApplication(formData: ApplicationFormData): Application {
  ...
  const newApp: Application = {
    ...
    status: ["applied", "interviewing", "offer", "rejected", "unresponsive"].includes(formData.status) 
      ? formData.status 
      : "applied",
